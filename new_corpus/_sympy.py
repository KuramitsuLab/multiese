...
sympy.symbol(s)
'''
@test(sympy=missing;_)
数式として、sをシンボルに変換する
'''

z = sympy.symbol(s)
'''
@test(sympy=missing;_;z)
@prefix(z;[変数|式])
...
sympy.solve(e, z)
'''
@test(sympy=missing;e='e';z='x';_)
数式として、方程e[=0|]のzの解を求める
'''

sympy.solve([e, e2])
'''
@test(sympy=missing;e='e';e2='e2';_)
...
sympy.limit(e, z, oo)
'''
@test(sympy=missing;e='e';z='x';oo='oo';_)
zが無限大に近づくとき[の|、]eの極限値を求める
'''

sympy.limit(e, z, -oo)
'''
@test(sympy=missing;e='e';z='x';oo=0;_)
...
float(e)
'''
@test(sympy=missing;e='3.14159';z='x';_)
数式として、eの数値[を求める|]
数式として、eを数値計算する

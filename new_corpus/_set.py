...
list(set(リスト).intersection(set(リスト2)))
'''
二つのリストの[積集合|共通要素|インターセクション][|を求める|を得る]
'''

list(set(リスト).difference(set(リスト2)))
'''
二つのリストの[差集合|差|差分][|を求める|を得る]
'''
